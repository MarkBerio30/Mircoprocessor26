const char* ssid     = "Jabines_Wi-Fi";  
const char* password = "Jabines@2002";  
...
<html>
    <head>
        ...
        <title>GarbDetect: Automated Wet and Dry Garbage Detection with IoT-based User Notification</title>
        <style>
        ...
        <script src=
        "https:\/\/cdn.jsdelivr.net/npm/@teachablemachine/image@0.8/dist/teachablemachine-image.min.js"></script>  
